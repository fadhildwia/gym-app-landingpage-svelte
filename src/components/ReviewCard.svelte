...
<div
  class={"flex flex-col w-full max-w-[500px] mx-auto relative " +
    (left
      ? index % 2 === 1
        ? "hidden md:flex opacity-0 pointer-events-none max-h-[400px] overflow-hidden"
        : " "
      : index % 2 === 0
...
>
  ...
  <div class="h-[1.5px] bg-slate-950 w-1/4 mr-auto mb-4"></div>
